# browseforfolder%5b1096957955%5d v1.0 by Unknown
...
**Script Name:** browseforfolder%5b1096957955%5d  
**Version:** 1.0  
**Category:** bot  
**Authors:** Unknown  
...
**Download Link:** [Download](https://github.com/sorzkode/mirc_scripts_archive/raw/main/mirc.net/browseforfolder%5b1096957955%5d/browseforfolder%5b1096957955%5d.zip)

## 📂 Zip File Structure (metadata parsed from .zip)

```json
{
  "name": "browseforfolder%5b1096957955%5d.zip",
  "file_count": 4,
  "file_types": [
    ".cpp",
    ".def",
...
Version - returns the DLL Info.



ex: //echo $dll(BrowseForFolder.dll,DllInfo,.)
```
