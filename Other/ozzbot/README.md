...
**Email(s):** <worm@usr5-13.mor.nj.webspan.net>, <x@channels.undernet.org>, <DrD_@pc54.sfe.no>  
**Website(s):**   
**Release Year:** 1997  
...
**Download Link:** [Download](https://github.com/sorzkode/mirc_scripts_archive/raw/main/Other/ozzbot/ozzbot.zip)
...
1.   Unzip Ozzbot.zip anywhere you want.  Then copy the mirc32.exe file to the
...
.&Start zZT:/run %ozzbotcl $+ mirc32.exe %ozzbotcl $+ bot.ini

.-

.&Setup:/.writeini %ozzbotcl $+ bot.ini botchannels autojoin $?="Auto-Join Channels; Separate by Commas" |  .writeini %ozzbotcl $+ bot.ini botchannels hourschannel $$?="Hours Channel?"

.&Set Join Channels:/.writeini %ozzbotcl $+ bot.ini botchannels autojoin $?="Channels; Separate by Commas, no spaces"

.&Set Chan for Hours:/.writeini %ozzbotcl $+ bot.ini botchannels hourschannel $$?="Channel?"

.-

.&Join Current Channel:/dde mircbot command "" /join #

.&Set Command Line:/echo 4 ex. If your command line for Ozzbot's mirc32.exe is c:\ozzbot\mirc32.exe enter c:\ozzbot\.  It can be anywhere is the computer, just remember to put \ at the end of it. | /set %ozzbotcl $$?="Where is Ozzbot (ex. c:\ozzbot\ )?"
...
...Choices:/set %choice1 $$?="First Choice?" | %choice2 = $$?="Second Choice?" | %choice3 = $$?="Third Choice?" | if ($left(1,%choice1)
```
