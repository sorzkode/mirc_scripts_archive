# I don't care what you v1.0 by Unknown
...
**Script Name:** I don't care what you  
**Version:** 1.0  
**Category:** addon  
**Authors:** Unknown  
**Email(s):**   
...
**Download Link:** [Download](https://github.com/sorzkode/mirc_scripts_archive/raw/main/irc-scripts.com/dict/dict.zip)
...
```json
{
  ...
  "max_file_date": "2000-01-22",
  "min_file_date": "2000-01-22",
  "total_size": 6.24,
  "largest_file": "dict.mrc",
  "text": [
    "dictReadMe.txt"
  ]
}
...
## 📋 Text Content (from dictReadMe.txt)
