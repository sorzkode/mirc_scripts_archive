# sergio clock v2 by seni0rebrasnetorg
...
**Script Name:** sergio clock  
**Version:** 2  
**Category:** addon  
**Authors:** seni0rebrasnetorg  
**Email(s):** <seni0re@brasnet.org>  
**Website(s):**   
**Release Year:** 2000  
**Tags:** dialog, popup, timer, addon, alias  
**Download Link:** [Download](https://github.com/sorzkode/mirc_scripts_archive/raw/main/mircscripts.org/sergio-clock/sergio-clock.zip)

## 📂 Zip File Structure (metadata parsed from .zip)

```json
{
  "name": "sergio-clock.zip",
  "file_count": 11,
  "file_types": [
    ".c1",
    ".mrc",
...
```text
clock.mrc by seni0re@brasnet.org
