# pp4finalupgrade v1.00 by mspai
...
**Script Name:** pp4finalupgrade  
**Version:** 1.00  
**Category:** game  
**Authors:** mspai  
**Email(s):** <pai@pairc.com>, <feedback@pairc.com>, <pnp@pairc.com>  
**Website(s):** [http://www.oz.org/z/](http://www.oz.org/z/), [http://cservice.undernet.org/docs/xwcoms.html](http://cservice.undernet.org/docs/xwcoms.html)  
**Release Year:** 2000  
**Tags:** wav, roulette, trigger, protection, notify, rejoin, away system, toolbar, nicklist, auto join, auto deop, auto-join, auto-op, font control, timer, weather, custom theme, alias, auto away, repeat protection, away log, last seen, auto-away, dcc, access list, auto-deop, channel protection, dice, sockets  
**Download Link:** [Download](https://github.com/sorzkode/mirc_scripts_archive/raw/main/pairc.com/pp4finalupgrade/pp4finalupgrade.zip)

## 📂 Zip File Structure (metadata parsed from .zip)

```json
{
  "name": "pp4finalupgrade.zip",
  "file_count": 119,
  "file_types": [
    ".bat",
    ".bmp",
  ...
  "max_file_date": "2000-04-14",
  "min_file_date": "1998-07-31",
  "total_size": 1097.41,
  "largest_file": "WHATSNEW.TXT",
  "text": [
    "ADDONS/GENRE.TXT",
    "ADDONS/services.txt",
    "pp-faq.txt",
